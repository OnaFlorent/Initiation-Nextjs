      ...
      <div className="container mx-auto flex items-center pt-48 pb-12 xl:pt-32 xl:pb-0">
        <div className="w-full h-full flex items-center justify-between">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-14 mx-auto xl:mx-0">
              ...
              <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                <div className="flex items-center gap-[12px] mb-2">
                  ...
                  <h3 className="text-2xl">Soin visage classique</h3>
                </div>
                <p className="pl-6 text-[15px] ">
                  Nettoyage en profondeur, exfoliation et hydratation pour un
                  teint rafraîchi
                </p>
              </div>
              {/* end item */}
              ...
              <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                <div className="flex items-center gap-[12px] mb-2">
                  <div className="w-[14px] h-[14px] bg-accent rounded-tl-[28px] rounded-bl-[28px] rounded-br-[22px] rounded-tr-[4px] "></div>
                  <h3 className="text-2xl">Gommage chimique</h3>
                </div>
                <p className="pl-6 text-[15px] ">
                  Traitement exfoliation pour améliorer la texture et le tonus
                  de la peau
                </p>
              </div>
              {/* end item */}
              ...
              <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                <div className="flex items-center gap-[12px] mb-2">
                  ...
                  <h3 className="text-2xl">
                    Épilation/Mise en forme des sourcils
                  </h3>
                </div>
                <p className="pl-6 text-[15px] ">
                  Nettoyage en profondeur, exfoliation et hydratation pour un
              ...
              <div className="flex-1 flex flex-col justify-center items-center xl:items-start">
                <div className="flex items-center gap-[12px] mb-2">
                  <div className="w-[14px] h-[14px] bg-accent rounded-tl-[28px] rounded-bl-[28px] rounded-br-[22px] rounded-tr-[4px] "></div>
                  <h3 className="text-2xl">Soin Hydrafacial/MD</h3>
                </div>
                <p className="pl-6 text-[15px] ">
                  Traitement multi-étapes pour une hydratation et un éclat
                  instantanés
                </p>
              </div>
              {/* end item */}
            ...
            {/* btn */}
            <button className="btn mx-auto xl:mx-0">En découvrir plus</button>
          </motion.div>
          {/* image */}
          <motion.div
            initial={{ opacity: 0, x: 60 }}
